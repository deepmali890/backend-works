...
import { fatchProductByParentCategory } from '@/app/redux/slices/productByParentCategory';
...
export default function Category() {
  ...
  return (
    <>
      <Header />
      <section className='   justify-between mt-[50px] md:px-5 px-0 pt-[30px]'>
        {/* <CategorySidebar /> */}
        <div className='sticky top-0 p-4 w-full h-screen overflow-y-scroll catListScroll'>
